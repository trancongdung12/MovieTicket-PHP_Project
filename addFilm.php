...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            <li><a href="dashboard.php"><em class="fas fa-chart-line">&nbsp;</em>Dashboard</a></li>
            <li class="parent ">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active"><?php if(isset($_GET['id'])){ echo 'Update Film';}else{echo 'Add Film';}  ?> </li>
            </ol>
        </div>
        <!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><?php if(isset($_GET['id'])){ echo 'Update Film';}else{echo 'Add Film';}  ?></h1>
            </div>
        </div>
        <!--/.row-->
            ...
            <form class="form-add" style="margin-left: 100px" method="post" enctype="multipart/form-data">
                <div class="form-row col-md-12">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="name" class="form-control" id="inputEmail4" value="<?php echo $name ?>" required>
                    </div>
                </div>
                <div class="form-row col-md-12">
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Link Video</label>
                        <input type="text" name="video" class="form-control" id="inputPassword4" value="<?php echo $video ?>"required>
                    </div>
                </div>
                <div class="form-row col-md-12">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" name="price" class="form-control" id="inputZip" value="<?php echo $price ?>" required>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="inputZip">Time</label>
                        <input type="text" name="time" class="form-control" id="inputZip" placeholder="00 hr 00 min" value="<?php echo $time ?>" required>
                    </div>
                </div>
                <div class="form-row col-md-12">
                    <div class="form-group col-md-3">
                        <label for="inputCity">Image</label>
                        <input type="file" name="image" class="form-control" id="inputCity" value="<?php echo $image ?>" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="inputState">Category</label>
                        <select id="inputState" name="category" class="form-control">
                            <option value="nowplay" <?php if ($category == 'nowplay') {
                                                    echo ' selected="selected"';
                                                } ?>>Now play</option>
                            <option value="thisweek" <?php if ($category == 'thisweek') {
                                                    echo ' selected="selected"';
                                                } ?>>This week</option>
                            <option value="comming" <?php if ($category == 'comming') {
                                                    echo ' selected="selected"';
                                                } ?>>Comming soon</option>
                        </select>
                    </div>                               
