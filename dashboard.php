...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            <li ><a href="#"><em class="fas fa-chart-line">&nbsp;</em>Dashboard</a></li>
            <li class="parent ">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row" id="row-dashboard">
            <div class="item-row" style="border-left: 5px solid #8ad919;">
                <p  style="color:#8ad919 ">EARNINGS (MONTHLY)</p>
                <b><?php echo number_format(getMoneyOfMonth()) ?>&emsp;vnđ</b>
            </div>
            <div class="item-row" style="border-left: 5px solid #f9243f;">
                <p style="color:#f9243f ">EARNINGS (ANNUAL)</p>
                <b><?php echo number_format(getMoneyOfDay()) ?>&emsp;vnđ</b>
            </div>
            <div class="item-row" style="border-left: 5px solid #ffb53e;">
                <p  style="color:#ffb53e ">ORDER</p>
                <b><?php echo getQuantityOrder() ?></b>
            </div>
            <div class="item-row" style="border-left: 5px solid #30a5ff;">
                <p  style="color:#30a5ff ">PENDING REQUESTS</p>
                <b>10</b>
            </div>
        </div>
