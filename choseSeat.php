...
<body>
    ...
    <div class="container" style="margin-top: 100px">
        ...
        <div class="title-seat">
            ...
            <button style="margin-left: 70px" class="seat-can"></button><span>Seat can choose</span>
            ...
            <div class="name-seat">
                ...
                <button class="vip-seat"></button><span>Vip Seat(+20k)</span>
                <button class="couple-seat"></button><span>Couple Seat(+50k)</span>
            </div>
                                    ...
                                    <div class="ticket-movie-title">
                                        <div style="margin-left: 10px;" class="info-ticket">
                                            ...
                                            <p style="margin-top: 25px;margin-left: -30px">
                                                ...
                                                <?php
                                                 echo number_format($_SESSION['price_film']) ?>  
                                                    đ</b>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div style="margin-left: 10px;" class="info-ticket">
                                            <p>
                                                <div class="info-ticket-div">
                                                    ...
                                                    $total = $vipPrice+ $coupPrice;
                                                    $_SESSION['totalPrice_film'] = $_SESSION['price_film'] * count($_SESSION['arrSeat'])+$total;
